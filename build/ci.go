...
import (
	...
	"github.com/hit-the-pic/op-geth/crypto/signify"
	"github.com/hit-the-pic/op-geth/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/hit-the-pic/op-geth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/hit-the-pic/op-geth/internal/version.gitDate="+env.Date)
	}
	if env.Tag != "" {
		ld = append(ld, "-X", "github.com/hit-the-pic/op-geth/params.gitTag="+env.Tag)
	}
